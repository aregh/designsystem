...
export function BloggKort({ dato, tittel, utdrag, href, bilete, alt = '', style }) {
  return (
    <article style={{ display: 'grid', gridTemplateColumns: bilete ? 'repeat(auto-fit, minmax(min(280px,100%),1fr))' : 'minmax(0,1fr)', gap: 'var(--rom-6)', alignItems: 'start', padding: 'var(--rom-7) 0', borderBottom: '1px solid var(--strek)', ...style }}>
